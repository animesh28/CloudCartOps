...
def get_products_by_category(category):
   ...
   try:
       ...
       # Record metrics
       duration = time.time() - start_time
       prometheus_metrics.http_requests_total.labels(method='GET', endpoint='/products/category/<category>', status='200').inc()
       prometheus_metrics.request_duration_seconds.labels(method='GET', endpoint='/products/category/<category>').observe(duration)
      
       return response
   except Exception as e:
       prometheus_metrics.errors_total.labels(error_type=type(e).__name__, endpoint='/products/category/<category>').inc()
       prometheus_metrics.http_requests_total.labels(method='GET', endpoint='/products/category/<category>', status='500').inc()
       raise
   finally:
       db.close()
...
def create_product():
   ...
   try:
       ...
       # Record metrics
       duration = time.time() - start_time
       prometheus_metrics.http_requests_total.labels(method='POST', endpoint='/products', status='201').inc()
       prometheus_metrics.request_duration_seconds.labels(method='POST', endpoint='/products').observe(duration)
      
       return response, 201
   except Exception as e:
       prometheus_metrics.errors_total.labels(error_type=type(e).__name__, endpoint='/products').inc()
       prometheus_metrics.http_requests_total.labels(method='POST', endpoint='/products', status='500').inc()
       raise
   finally:
       db.close()
...
def update_product(product_id):
   ...
   try:
       ...
       if not product:
           prometheus_metrics.http_requests_total.labels(method='PUT', endpoint='/products/<id>', status='404').inc()
           return jsonify({'error': 'Product not found'}), 404
       ...
       # Record metrics
       duration = time.time() - start_time
       prometheus_metrics.http_requests_total.labels(method='PUT', endpoint='/products/<id>', status='200').inc()
       prometheus_metrics.request_duration_seconds.labels(method='PUT', endpoint='/products/<id>').observe(duration)
      
       return response
   except Exception as e:
       prometheus_metrics.errors_total.labels(error_type=type(e).__name__, endpoint='/products/<id>').inc()
       prometheus_metrics.http_requests_total.labels(method='PUT', endpoint='/products/<id>', status='500').inc()
       raise
   finally:
       db.close()
...
def delete_product(product_id):
   ...
   try:
       ...
       if not product:
           prometheus_metrics.http_requests_total.labels(method='DELETE', endpoint='/products/<id>', status='404').inc()
           return jsonify({'error': 'Product not found'}), 404
       ...
       # Record metrics
       duration = time.time() - start_time
       prometheus_metrics.http_requests_total.labels(method='DELETE', endpoint='/products/<id>', status='200').inc()
       prometheus_metrics.request_duration_seconds.labels(method='DELETE', endpoint='/products/<id>').observe(duration)
      
       return response
   except Exception as e:
       prometheus_metrics.errors_total.labels(error_type=type(e).__name__, endpoint='/products/<id>').inc()
       prometheus_metrics.http_requests_total.labels(method='DELETE', endpoint='/products/<id>', status='500').inc()
       raise
   finally:
       db.close()
